...
DEFINE_LOG_CATEGORY_STATIC(LogHktProtoServer, Log, All);

IMPLEMENT_APPLICATION(HktProtoServer, "HktProtoServer");
...
INT32_MAIN_INT32_ARGC_TCHAR_ARGV()
{
	...
	UE_LOG(LogHktProtoServer, Display, TEXT("Shutting down HktProtoServer..."));

	HktServer.Shutdown();

	UE_LOG(LogHktProtoServer, Display, TEXT("HktProtoServer shut down."));
